# Generated by Django 4.2.4 on 2023-08-29 22:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_status', models.PositiveSmallIntegerField(choices=[(0, '未开始'), (1, '进行中'), (2, '已完成')], db_index=True, default=0, help_text='项目状态', verbose_name='项目状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sprint_status', models.PositiveSmallIntegerField(choices=[(0, '未开始'), (1, '进行中'), (2, '已完成')], db_index=True, default=0, help_text='迭代状态', verbose_name='迭代状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(db_index=True, help_text='负责人', max_length=150, verbose_name='负责人')),
                ('work_item_type', models.PositiveSmallIntegerField(choices=[(0, '需求'), (1, '任务'), (2, '缺陷')], db_index=True, help_text='工作项类型', verbose_name='工作项类型')),
                ('priority', models.PositiveSmallIntegerField(choices=[(0, '最低'), (1, '较低'), (2, '普通'), (3, '较高'), (4, '最高')], db_index=True, help_text='优先级', verbose_name='优先级')),
                ('work_item_status', models.PositiveSmallIntegerField(choices=[(0, '未开始'), (1, '待处理'), (2, '重新打开'), (3, '进行中'), (4, '实现中'), (5, '已完成'), (6, '修复中'), (7, '已实现'), (8, '关闭'), (9, '已修复'), (10, '已验证'), (11, '已拒绝')], db_index=True, default=0, help_text='状态', verbose_name='状态')),
                ('severity', models.PositiveSmallIntegerField(blank=True, choices=[(0, '保留'), (1, '建议'), (2, '提示'), (3, '一般'), (4, '严重'), (5, '致命')], db_index=True, help_text='缺陷严重程度', null=True, verbose_name='缺陷严重程度')),
                ('bug_type', models.PositiveSmallIntegerField(blank=True, choices=[(0, '功能问题'), (1, '性能问题'), (2, '接口问题'), (3, '安全问题'), (4, 'UI界面问题'), (5, '易用性问题'), (6, '兼容问题'), (7, '数据问题'), (8, '逻辑问题'), (9, '需求问题')], db_index=True, help_text='缺陷类型', null=True, verbose_name='缺陷类型')),
                ('process_result', models.PositiveSmallIntegerField(blank=True, choices=[(0, '不予处理'), (1, '延期处理'), (2, '外部原因'), (3, '需求变更'), (4, '转需求'), (5, '挂起'), (6, '设计如此'), (7, '重复缺陷'), (8, '无法重现')], db_index=True, help_text='缺陷处理结果', null=True, verbose_name='缺陷处理结果')),
